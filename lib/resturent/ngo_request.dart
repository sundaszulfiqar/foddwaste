...
class NgoRequest extends StatefulWidget {
  const NgoRequest({Key? key}) : super(key: key);

  @override
  State<NgoRequest> createState() => _NgoRequestState();
}

class _NgoRequestState extends State<NgoRequest> {
  final deliveryList = [
    {
